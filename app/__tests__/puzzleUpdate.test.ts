...
test.todo(
  'should remove from notifications and update indexes when a private puzzle is marked public'
);
...
test.todo(
  'should remove from notifications and update indexes when a private until puzzle is marked private'
);
